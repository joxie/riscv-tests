...
class spike64_sdsec_vsmode_hsonly_hart(targets.Hart):
    xlen = 64
    ram = 0x1212340000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike64_sdsec_vsmode_hsonly(targets.Target):
    harts = [spike64_sdsec_vsmode_hsonly_hart()]
    ...
    sdsec_vsmode_hsonly = True  # hart stays in HS-mode, never enters VS-mode
    ...
    def create(self):
        ...
        return testlib.Spike(self, isa="RV64IMAFCH_sdsec",
                ...
                init_compile_args=("programs/sdsec_vsmode_hsonly.S",))
