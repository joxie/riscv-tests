...
class spike64_sdsec_full_hart(targets.Hart):
    xlen = 64
    ram = 0x1212340000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike64_sdsec_full(targets.Target):
    harts = [spike64_sdsec_full_hart()]
    openocd_config_path = "spike-sdsec-full.cfg"
    timeout_sec = 180
    support_sdsec = True
