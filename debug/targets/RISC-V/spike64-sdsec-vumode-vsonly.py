...
class spike64_sdsec_vumode_vsonly_hart(targets.Hart):
    xlen = 64
    ram = 0x1212340000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike64_sdsec_vumode_vsonly(targets.Target):
    """Hart loops in VS-mode (sdsec_vsmode.S).  With only UEDBGALW=1,
    halt in VS-mode must be denied — VU-mode debug privilege cannot
    halt a VS-mode hart."""
    harts = [spike64_sdsec_vumode_vsonly_hart()]
    ...
    def create(self):
        ...
        return testlib.Spike(self, isa="RV64IMAFCH_sdsec",
                ...
                init_compile_args=("programs/sdsec_vsmode.S",))
