...
class spike64_sdsec_umode_vm_hart(targets.Hart):
    xlen = 64
    ram = 0x1212340000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike64_sdsec_umode_vm(targets.Target):
    harts = [spike64_sdsec_umode_vm_hart()]
    ...
    def create(self):
        ...
        return testlib.Spike(self, isa="RV64IMAFC_sdsec",
                ...
                init_compile_args=("programs/sdsec_umode_vm.c",))
