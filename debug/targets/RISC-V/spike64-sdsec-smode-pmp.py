...
class spike64_sdsec_smode_pmp_hart(targets.Hart):
    xlen = 64
    ram = 0x1212340000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike64_sdsec_smode_pmp(targets.Target):
    harts = [spike64_sdsec_smode_pmp_hart()]
    ...
    def create(self):
        ...
        return testlib.Spike(self, isa="RV64IMAFC_sdsec",
                ...
                init_compile_args=("programs/sdsec_smode_pmp.c",))
