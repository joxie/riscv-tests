...
class spike64_sdsec_umode_pmp_hart(targets.Hart):
    xlen = 64
    ram = 0x1212340000
    ram_size = 0x10000000
    bad_address = ram - 8
...
class spike64_sdsec_umode_pmp(targets.Target):
    harts = [spike64_sdsec_umode_pmp_hart()]
